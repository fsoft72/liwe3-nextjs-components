...
const CheckBox = ( props: CheckBoxProps ) => {
	...
	const [cbState, setCbState] = useState<boolean>(initialCbState);
	/*
	const handleChange = () => {
		console.log('checkbox clicked');
		const checked = !cbState;
		setCbState(checked);
		onChange?.(cbState);
	};
	*/
	...
	return (
		(props.type === 'squared') ? <Squared {...props} cbState handleChange={handleChange} setCbState={setCbState}/> : <Rounded {...props} cbState handleChange={handleChange} setCbState={setCbState}/>
	);
};
